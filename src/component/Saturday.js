...
const Saturday = () => {
    return (
        <div style={{display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center', marginBottom:'5rem'}}>
            <h1 className="title-text-english">Wedding Day At Villa Guicciardini</h1>
            <p className="text-english">Join In Us At Our Wedding</p>
            <p className="text-english">At</p>
            <a href="https://maps.app.goo.gl/Ahw3sCXbrR6uMVNE7" className="text-english">Villa Guicciardini</a>
            <p className="text-english">3:00 PM</p>
            <p className="text-english">Via Nuova per Migliana, 1, 59025 Cantagallo PO, Italy</p>
            <div>
