    ...
    return (
        <>
            <div style={{display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center', marginBottom:'5rem'}}>
                ...
                <a href="https://maps.app.goo.gl/MJAe27zr3p83GLcw9" className="text-english-tab">Ristorante Le Fontanelle</a>
            ...
            <div style={{display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center', marginBottom:'5rem'}}>
                ...
                <a href="https://maps.app.goo.gl/7tWSWhcC53rFWexe8" className="text-english-tab">Wall Art Apartmenthotel</a>
